...
const PaymentScreen = ({ route,navigation }) => {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      // const response = await trainerService.createPayment(paymentData)
      // if (response.statusCode === 201) {
      //   Alert.alert("Payment Initiated","Your payment request has been submitted successfully.",[
      //     {
      //       text: "View Details",
      //       onPress: () =>
      ...
      navigation.navigate("QRPaymentScreen",{
        amount: price || 0,
        packageName: "demo",
        paymentUrl: "https://pay.payos.vn/web/d5dcc785e1044f49a96eee52a4ee50ff"
      });
    } catch (error) {
      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.packageInfo}>
            <LinearGradient colors={["#EEF2FF","#F8FAFC"]} style={styles.packageIconContainer}>
              <MaterialCommunityIcons name="dumbbell" size={32} color="#4F46E5" />
            </LinearGradient>
        ...
        <View style={styles.paymentMethodCard}>
          ...
          <View style={styles.paymentMethodItem}>
            <LinearGradient colors={["#EEF2FF","#F8FAFC"]} style={styles.paymentMethodIcon}>
