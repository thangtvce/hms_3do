...
const GOOGLE_CLIENT_ID = "336337631794-cil4f7sd9oj7dcsqflf6u7buambcsukk.apps.googleusercontent.com"
...
export default function LoginScreen() {
  ...
  const showErrorAlert = (message) => {
    Alert.alert("Login Error",message,[{ text: "OK",onPress: () => console.log("OK Pressed") }])
  }
  ...
  const handleGoogleLogin = async (token) => {
    setIsLoading(true)
    try {
      // Call your API with the Google token
      ...
      >
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.innerContainer}>
            <LinearGradient colors={["#4F46E5","#6366F1","#818CF8"]} style={styles.headerGradient}>
